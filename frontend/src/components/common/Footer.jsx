        ...
        <div className='row'>
          <div className='col-md-3 pb-4'>
            ...
            <div className='pt-3 pe-5'>
              <FaMapMarkerAlt style={{ color: 'red', marginRight: '12px' }} />
        <span> Gakhar Palaza Basement Lehtrar Road Alipur.</span>
            </div>
          </div>
          <div className='col-md-3 pb-4'>
          ...
          <div className='col-md-3'>
            ...
            <ul>
              <li>
                <a href="#">03405669057</a>
              </li>
              <li>
                <a href="#">infoexample@gmail.com</a>
              </li>
              <div className='socialicon row py-3 text-center'>
              <div className='facebook-icon col-md-3 pb-4'>
                   <SocialIcon url="https://facebook.com/jaketrent" />
              </div>
              <div className='whatapp-icon col-md-3'>
              <SocialIcon url="https://wa.me/+923405669057" />
              </div>
              </div>
            </ul>
          </div>
